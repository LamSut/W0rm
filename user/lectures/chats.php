  ...
  <script>
    ...
    <?php
      if (isset($_POST['sendForm']) && !empty($_POST['textNews'])) {
        ...
        echo '<script>window.location.href = "http://localhost/w0rm/user/lectures/chats.php?idlectures=' . $idlecture .'";</script>';
        exit;
      }
      ...
      if(isset($_GET['del'])){
        ...
        // $idlecture = $_GET['idlectures'];
        // echo '<script>window.location.href = "http://localhost/w0rm/user/lectures/chats.php?idlectures=' . $idlecture .'";</script>';
        echo '<script>window.location.href = "http://localhost/w0rm/user/lectures/chats.php";</script>';
      }
    ?>
</body>
